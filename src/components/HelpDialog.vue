        ...
        <v-card class="pa-0" color="elevation3">
            ...
            <v-card-text class="pa-0">
                <v-list class="transparent" color="text--onSurface">
                    <v-list-item :href="!item.isRouterUrl ? item.href : null" :to="item.isRouterUrl ? item.href : null" @click="show = false" ripple v-for="(item, i) in data" :key="i">
                        <v-list-item-icon>
